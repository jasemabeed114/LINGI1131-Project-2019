...
\begin{itemize}
	...
	\item Impossible de faire fonctionner le joueur suivant (en tout cas au moement où nous avons testé ce joueur): \texttt{Player022smart} (groupe 22).
\end{itemize}
...
Voici une liste de numéro de groupes de personnes qui nous ont donné un \emph{feedback} sur nos joueurs intelligents. Pour chacun d'entre d'entre eux, le retour était positif: 01, 07, 10, 21, 22, 55, 105. Le feedback du groupe 118 nous a permis de trouver une erreur \emph{floating point} dans un cas particulier de nos joueurs intelligents.
\section{Extensions}
